...
aliases['nCleanGenJet'] = {
    'linesToAdd': ['.L /afs/cern.ch/user/p/pdesirev/private/CMSSW_10_6_10/src/PlotsConfigurations/Configurations/Differential/ngenjet.cc+'],
    'class': 'CountGenJet',
    'samples': mc
}
...
aliases['Jet_btagSF_deepflav_shape'] = {
    'linesToAdd': [
        ...
        '.L /afs/cern.ch/user/p/pdesirev/private/CMSSW_10_6_10/src/PlotsConfigurations/Configurations/patches/btagsfpatch.cc+'
    ],
    'class': 'BtagSF',
...
aliases['Weight2MINLO'] = {
    'linesToAdd': ['.L /afs/cern.ch/user/p/pdesirev/private/CMSSW_10_6_10/src/PlotsConfigurations/Configurations/Differential/weight2MINLO.cc+'],
    'class': 'Weight2MINLO',
...
aliases['ALP_ME']={
    'linesToAdd': [
        'gSystem->Load("/afs/cern.ch/user/p/pdesirev/private/CMSSW_10_6_10/lib/libLHAPDF.so", "", kTRUE);',
        'gSystem->Load("/afs/cern.ch/user/p/pdesirev/private/CMSSW_10_6_10/lib/libmomemta.so.1.0.0","", kTRUE);',
        'gSystem->Load("/afs/cern.ch/user/p/pdesirev/private/CMSSW_10_6_10/lib/libmomemta.so.1","", kTRUE);',
        'gSystem->Load("/afs/cern.ch/user/p/pdesirev/private/CMSSW_10_6_10/lib/libmomemta.so","", kTRUE);',
        '.L /afs/cern.ch/user/p/pdesirev/private/CMSSW_10_6_10/src/PlotsConfigurations/Configurations/patches/matrixElement_ALP.cc+'],
    'class': 'RecoME',
    'args': 'Axion'
}
...
aliases['DY_ME']={
    'linesToAdd': [
        ...
        'gSystem->Load("/afs/cern.ch/user/p/pdesirev/private/CMSSW_10_6_10/lib/libmomemta.so.1","", kTRUE);',
        'gSystem->Load("/afs/cern.ch/user/p/pdesirev/private/CMSSW_10_6_10/lib/libmomemta.so.1.0.0","", kTRUE);',
	'.L %s/patches/matrixElement_ALP.cc+' % configurations],
    'class': 'RecoME',
    'args': 'DY'
}

aliases['D_DY']     = { 'expr': 'abs(ALP_ME)/(abs(ALP_ME) + abs(DY_ME))' }
...
for thu in thus:
    aliases[thu+'_2'] = {
        'linesToAdd': ['.L /afs/cern.ch/user/p/pdesirev/private/CMSSW_10_6_10/src/PlotsConfigurations/Configurations/Differential/gghuncertainty.cc+'],
