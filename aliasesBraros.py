...
aliases['nCleanGenJet'] = {
    'linesToAdd': ['.L /afs/cern.ch/user/p/pdesirev/private/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/Differential/ngenjet.cc+'],
    'class': 'CountGenJet',
    'samples': mc
}
...
if btag_algo=="deepcsv":
    ...
    aliases['Jet_btagSF_deepflav_shape'] = {
        'linesToAdd': [
            ...
            '.L /afs/cern.ch/user/p/pdesirev/private/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/patches/btagsfpatch.cc+' 
        ],
        'class': 'BtagSF',
...
aliases['Weight2MINLO'] = {
    'linesToAdd': ['.L /afs/cern.ch/user/p/pdesirev/private/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/Differential/weight2MINLO.cc+'],
    'class': 'Weight2MINLO',
...
for thu in thus:
    aliases[thu+'_2'] = {
        'linesToAdd': ['.L /afs/cern.ch/user/p/pdesirev/private/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/Differential/gghuncertainty.cc+'],
